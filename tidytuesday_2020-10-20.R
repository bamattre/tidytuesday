...
top_styles %>%
  ggplot(aes(state = state, fill = style)) +
  geom_statebins(radius = grid::unit(5, "pt"), na.rm = FALSE,
                 border_size = 2, size = 1, border_col = "#242F40") +
...
ggsave(r"(C:\Users\riba001\OneDrive - Hennepin County\Learning and Experiments\Tidy Tuesday\2020-10-20 beer.png)", device = "png", dpi = 150)
